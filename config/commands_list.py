commands = [
    ...
    },
    {
        ...
        "CIS.NO": "3.11",
        "cmd": r'Get-VMHOST | Get-AdvancedSetting -Name “Security.PasswordQualityControl"" | Set-AdvancedSetting -Value "retry=3 min=disabled,disabled,disabled,disabled,20"'
    },
    {
        "NO": "2.8",
        "name": "Host must lock an account after a specified number of failed login attempts (Automated)",
        "CIS.NO": "3.12",
        "cmd": r'Get-VMHost | Get-AdvancedSetting -Name Security.AccountLockFailurev'
    },
    {
        "NO": "2.9",
